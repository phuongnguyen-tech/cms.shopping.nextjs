    ...
    <Dialog open={showEdit} onClose={() => setShowEdit(false)}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          />
          <TextField fullWidth {...register('bannerUrl')} label="Banner Url" variant="standard" />
          ...
          />
          <TextField fullWidth {...register('slug')} label="Slug" variant="standard" />
          ...
          <TextField fullWidth {...register('categoryId')} label="CategoryId" variant="standard" />
          <DialogActions>
